...
import com.obss.javasummerschool.bookportal.model.audit.DateAudit;
...
public class User extends DateAudit {
    ...
    public User(@NotBlank String name, @NotBlank String username, @NotBlank @Email String email, @NotBlank String password) {
        this.name = name;
